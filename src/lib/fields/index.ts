...
// General fields
export const generalFields: FormFieldItem[] = [
  {
    id: 'analysisPeriod',
...
// Compute fields
export const computeFields: FormFieldItem[] = [
...
// Energy fields
export const energyFields: FormFieldItem[] = [
  // Colocation
  {
...
// GPU fields
export const gpuFields: FormFieldItem[] = [
...
export const humanResourcesFields: FormFieldItem[] = [
...
// Networking fields
export const networkingFields: FormFieldItem[] = [
...
// Software fields
export const softwareFields: FormFieldItem[] = [
...
// Combined fields array for backward compatibility
