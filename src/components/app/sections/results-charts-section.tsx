...
import { CapExOpExChart } from '../capex-opex-chart'
    ...
    <Card>
      ...
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <div
              ...
              style={{
                transform: `translateX(${
                  activeTab === 'cloud-chart'
                    ? '100%'
                    : activeTab === 'onprem-capex-opex'
                      ? '200%'
                      : '0%'
                })`,
              }}
          ...
          <TabsContent value="onprem-capex-opex" className="pt-4">
            <CapExOpExChart data={yearlyCosts} type="onprem" />
          </TabsContent>
        </Tabs>
      </CardContent>
    </Card>
